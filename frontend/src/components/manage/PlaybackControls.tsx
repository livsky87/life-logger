    ...
    <div className="border-t border-gray-200 bg-white px-4 py-3 space-y-2">
      ...
      <div className="flex items-center gap-3">
        <span className="text-xs font-mono text-gray-500 w-10 shrink-0">
          {entries[0] ? `${String(entries[0].hour).padStart(2, "0")}:${String(entries[0].minute).padStart(2, "0")}` : "00:00"}
        </span>
        ...
        <span className="text-xs font-mono text-gray-500 w-10 shrink-0 text-right">
          {entries.length > 0
            ? `${String(entries[entries.length - 1].hour).padStart(2, "0")}:${String(entries[entries.length - 1].minute).padStart(2, "0")}`
            : "23:59"}
        </span>
      </div>
