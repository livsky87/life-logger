...
from app.infrastructure.db.repositories.simulation_repository import SQLAlchemySimulationRepository
...
def get_simulation_service(db: DBSession) -> SimulationService:
    return SimulationService(SQLAlchemySimulationRepository(db))
